...
struct CloudSources_
{
  ...
  _cloud_type cloud;
   ...
   typedef std::vector< ::std_msgs::Int64_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::std_msgs::Int64_<ContainerAllocator> >::other >  _camera_source_type;
  _camera_source_type camera_source;

   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Point_<ContainerAllocator> >::other >  _view_points_type;
