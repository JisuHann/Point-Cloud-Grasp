...
"""autogenerated by genpy from gpd_ros/CloudSources.msg. Do not edit."""
import codecs
import sys
...
class CloudSources(genpy.Message):
  _md5sum = "db42f0bd3c98d8b681c7942579de88bd"
  _type = "gpd_ros/CloudSources"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# This message holds a point cloud that can be a combination of point clouds 
...
float64 z
"""
  __slots__ = ['cloud','camera_source','view_points']
  _slot_types = ['sensor_msgs/PointCloud2','std_msgs/Int64[]','geometry_msgs/Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       cloud,camera_source,view_points
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.camera_source:
        _x = val1.data
        buff.write(_get_struct_q().pack(_x))
      length = len(self.view_points)
      buff.write(_struct_I.pack(length))
      for val1 in self.view_points:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.camera_source.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.view_points = []
