...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox3d>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox3d)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task_assembly-msg:<BoundingBox3d> is deprecated: use task_assembly-msg:BoundingBox3d instead.")))

(cl:ensure-generic-function 'Class-val :lambda-list '(m))
(cl:defmethod Class-val ((m <BoundingBox3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:Class-val is deprecated.  Use task_assembly-msg:Class instead.")
  (Class m))

(cl:ensure-generic-function 'probability-val :lambda-list '(m))
(cl:defmethod probability-val ((m <BoundingBox3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:probability-val is deprecated.  Use task_assembly-msg:probability instead.")
  (probability m))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <BoundingBox3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:xmin-val is deprecated.  Use task_assembly-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'ymin-val :lambda-list '(m))
(cl:defmethod ymin-val ((m <BoundingBox3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:ymin-val is deprecated.  Use task_assembly-msg:ymin instead.")
  (ymin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <BoundingBox3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:xmax-val is deprecated.  Use task_assembly-msg:xmax instead.")
  (xmax m))

(cl:ensure-generic-function 'ymax-val :lambda-list '(m))
(cl:defmethod ymax-val ((m <BoundingBox3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:ymax-val is deprecated.  Use task_assembly-msg:ymax instead.")
  (ymax m))

(cl:ensure-generic-function 'zmin-val :lambda-list '(m))
(cl:defmethod zmin-val ((m <BoundingBox3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:zmin-val is deprecated.  Use task_assembly-msg:zmin instead.")
  (zmin m))

(cl:ensure-generic-function 'zmax-val :lambda-list '(m))
(cl:defmethod zmax-val ((m <BoundingBox3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:zmax-val is deprecated.  Use task_assembly-msg:zmax instead.")
  (zmax m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BoundingBox3d>)))
  ...
  "6e20dcf06c2cb2c3714e76bbf196e60c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BoundingBox3d)))
  "Returns md5sum for a message object of type 'BoundingBox3d"
  "6e20dcf06c2cb2c3714e76bbf196e60c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBox3d>)))
  ...
  (cl:format cl:nil "string Class~%float64 probability~%float64 xmin~%float64 ymin~%float64 xmax~%float64 ymax~%float64 zmin~%float64 zmax~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBox3d)))
  "Returns full string definition for message of type 'BoundingBox3d"
  (cl:format cl:nil "string Class~%float64 probability~%float64 xmin~%float64 ymin~%float64 xmax~%float64 ymax~%float64 zmin~%float64 zmax~%~%~%"))
