...
(cl:defclass <BoundingBoxes3d> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector task_assembly-msg:BoundingBox3d)
   :initform (cl:make-array 0 :element-type 'task_assembly-msg:BoundingBox3d :initial-element (cl:make-instance 'task_assembly-msg:BoundingBox3d))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes3d>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes3d)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task_assembly-msg:<BoundingBoxes3d> is deprecated: use task_assembly-msg:BoundingBoxes3d instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <BoundingBoxes3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:header-val is deprecated.  Use task_assembly-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'bounding_boxes-val :lambda-list '(m))
(cl:defmethod bounding_boxes-val ((m <BoundingBoxes3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_assembly-msg:bounding_boxes-val is deprecated.  Use task_assembly-msg:bounding_boxes instead.")
  (bounding_boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes3d>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'task_assembly-msg:BoundingBox3d))
