...
"""autogenerated by genpy from gb_visual_detection_3d_msgs/BoundingBoxes3d.msg. Do not edit."""
import codecs
import sys
...
import gb_visual_detection_3d_msgs.msg
import std_msgs.msg

class BoundingBoxes3d(genpy.Message):
  _md5sum = "105285518cb176da52bda2a8cc5bd348"
  _type = "gb_visual_detection_3d_msgs/BoundingBoxes3d"
...
"""
  ...
  _slot_types = ['std_msgs/Header','gb_visual_detection_3d_msgs/BoundingBox3d[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BoundingBoxes3d, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = gb_visual_detection_3d_msgs.msg.BoundingBox3d()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
